...
module.exports = class BattleCommand extends Command {
  ...
  msg.say(`${user} was too scared to fight you! ${msg.author}`)
    ...
    this.client.channels.get('566184370759794701').send(`Battle Started: **${msg.author.tag} vs ${user.tag}**`)
        ...
        let authorsdamage = this.client.profile.get(msg.author.id, "damage")
        let opponentdamage = this.client.profile.get(user.id, "damage")
        ...
        while(authorshealth > 1 && opponenthealth > 1) {
            ...
            if (authorshealth < 1) {
              ...
              this.battle.delete(msg.channel.id)
                                this.client.channels.get('566184370759794701').send(`Battle Ended: **${msg.author.tag} vs ${user.tag}**\nWinner: **$user.tag}**`)
              return;
...
function win(msg, client, loserhealth, winnerhealth, winner, loser) {
